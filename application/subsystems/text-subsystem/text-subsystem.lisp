...
(deflazy (block-width :unchanged-if =) ()
  *block-width*)
(deflazy (block-height :unchanged-if =) ()
  *block-height*)
(deflazy (indirection-width :unchanged-if =) ((w application::w))
  (power-of-2-ceiling w))
(deflazy (indirection-height :unchanged-if =) ((h application::h))
